...
public class Locales {
    ...
    public Locales(int codigoLocal, double saldoFavor, double saldoContra, 
            int mesesPendientes, boolean disponibilidad, double valorLocal, double valorAdministracion) {
    ...
    public String toString() {
        return getCodigoLocal() + "|" + isDisponibilidad()+ "|" + "Q." +  getValorLocal();
    }
